...
module.exports = class Reporter {
	 ...
	 *
	 * @param {string|object} provider  Provider of the email account to send from (e.g. gmail, hotmail, icloud. see full list here: https://github.com/nodemailer/nodemailer-wellknown#supported-services)
	 ...
	 * @param {string} name             [Optional] Alias name to use for the email address.
	 */
	 ...
	 * Send an email.
	 *
	 * @param {(string|string[])} recipients	List of email addresses to send the email to
	 * @param {string} subject					Subjust to use for the email
	 * @param {string} body						Contents to use for the body of the email
	 *
