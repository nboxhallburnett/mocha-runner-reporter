...
module.exports = class Runner {
	...
	generateReport (suiteName, data) {
		...
		const title = this._reportConstructor(suiteName, data);
	...
	/**
	 * Generates a body to be used in an email report that only contains failures and slows
	 *
	 * @param {String} suiteName Name of the test suite being ran
	 * @param {Object} data Data that was generated from the Mocha test run
	 *
	 * @returns {String} Body to be used in the report body
	 */
	generateMinimalReport (suiteName, data) {

		let title = this._reportConstructor(suiteName, data);
	 ...
	 */
	_reportConstructor(suiteName, data) {
		if (!suiteName) {
